...
data.
\todo{Say something about tesseroid forward modeling and cite paper.}
...
When using tesseroids, forward modeling requires several trigonometric function
evaluations as well as adaptive discretization.
\todo{Cite forward modeling paper}
Both factor contribute significantly to the total computation time.
