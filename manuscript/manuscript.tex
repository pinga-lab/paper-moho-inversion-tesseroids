...
Fig.~\ref{fig:crust1-results} summarizes the final results.
...
We run the inversion for each combination of $z_{ref}$ and $\Delta\rho$,
...
the true Moho depth shown in Fig.~\ref{fig:crust1-data}a
and the estimate.
...
The residuals follow the same pattern as the differences shown in
Fig.~\ref{fig:crust1-results}d,
with the largest residuals (in absolute value) along the Andes.
The pattern of the residuals is inverted, though,
