...
We computed the mean square error (MSE, Eq.~\ref{eq:msemu}) for each estimate.
The final estimated Moho depth is the one that minimizes the MSE.
...
We investigated the computation time spent in each section of the inversion
...
The profiling results are presented in table~\ref{profiling}.
The time spent on forward modeling accounts for approximately
