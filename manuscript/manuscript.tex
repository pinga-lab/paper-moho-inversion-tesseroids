...
\begin{figure*}
    ...
    \caption{
        ...
        (a) Inversion residuals (observed data in Fig.~\ref{fig:sam-data}a
...
Basins, and in the Paraná Basin, our Moho depth model is able to fit the
gravity data but differs significantly from the seismic data.
