...
\begin{figure}
    \centering
    \includegraphics[width=\columnwidth]{figures/synthetic-simple-data}
    \caption{
...
\begin{figure*}
    \centering
    \includegraphics[]{figures/synthetic-simple-results}
    \caption{
        ...
        (d) Normalized histogram of the residuals. Also shown are the calculated
...
\begin{figure*}
    \centering
    \includegraphics{figures/synthetic-crust1-data}
    \caption{
...
\begin{figure*}
    \centering
    \includegraphics{figures/synthetic-crust1-results}
    \caption{
    CRUST1 results.
    }
...
\begin{figure*}
    \centering
    \includegraphics{figures/south-america-data}
...
\begin{figure}
    \centering
    \includegraphics{figures/south-america-sedfree-bouguer}
    \caption{Sediment-free Bouguer disturbance for South America.}
    \label{fig:sam-gravity}
\end{figure}

\begin{figure}
    \centering
    \includegraphics{figures/south-america-seismic}
    \caption{Map of seismic point estimates of Moho depth.}
    \label{fig:sam-seismic}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics{figures/default_figure}
...
\begin{figure}
    \centering
    \includegraphics{figures/default_figure}
    \caption{Results of the inversion: residuals map, residuals histogram etc.}
...
\begin{figure}
    \centering
    \includegraphics{figures/default_figure}
    \caption{Cross-validation and convergence.}
    \label{fig:sam-cv}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics{figures/default_figure}
    \caption{Difference with seismic.}
    \label{fig:sam-seismic-diff}
\end{figure}
