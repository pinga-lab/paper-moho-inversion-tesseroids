...
Benchmarks suggest that forward modeling accounts for approximately $99\%$ of
\todo{Checar esse número}
the computation time for a Gauss-Newton inversion
(see supplementary material)\todo{Referência melhor pra isso}.
