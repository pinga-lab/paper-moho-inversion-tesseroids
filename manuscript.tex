...
using the closed-form solution presented by \citet{li_2001}.
...
Gauss-Legendre Quadrature (GLQ) integration \citep{asgharzadeh_2007}.
The accuracy of the GLQ integration is improved by the adaptive discretization
scheme of \citet{uieda_2016}.
...
regularization \citep{silva_2001}.
...
\citet{bott_1960} developed an efficient method to determined the basement
...
\citet{silva_2014} showed that Bott's method can be formulated as
