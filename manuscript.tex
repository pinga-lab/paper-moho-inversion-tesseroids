...
\begin{figure}
    \centering
    \includegraphics[width=0.5\columnwidth]{figures/default_figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\columnwidth]{figures/paper/tesseroid-coord-sys}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\columnwidth]{figures/default_figure}
    \caption{Include figure of the grid point separation from ON seminar}
...
The implementation relies on the open-source libraries
...
for geophysics specific tasks (e.g., forward modeling).
...
The Python implementation of the inversion as well as the Jupyter notebooks are
freely available under the terms of the BSD 3-clause open-source license.
Both can be found at the online repository
\url{https://github.com/pinga-lab/paper-moho-inversion-tesseroids}.
An archived version is also available at
\url{http://dx.doi.org/DOI_HERE} (made available upon publication).
\todo{Insert Zenodo DOI here}


\todo{Check which conjugate gradient scipy uses}
